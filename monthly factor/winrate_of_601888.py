...
data=DataAPI.MktEqumGet(beginDate=u"20100101",endDate=u"20180701",secID='601888.XSHG',field=u"secID,endDate,chgPct",pandas="1")
data['month']=0
for i in range(len(data['endDate'])):
    data['month'][i]=data['endDate'][i][5:7]

indexdata=DataAPI.MktIdxmGet(beginDate=u"20100101",endDate=u"20180701",indexID=u"000300.ZICN",field=u"endDate,chgPct",pandas="1")
